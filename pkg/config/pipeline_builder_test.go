...
func TestKafkaPromPipeline(t *testing.T) {
	...
	b, err = json.Marshal(params[2])
	require.NoError(t, err)
	require.JSONEq(t, `{"name":"conntrack","extract":{"type":"conntrack","conntrack":{"KeyDefinition":{"FieldGroups":null,"Hash":{"FieldGroupRefs":null,"FieldGroupARef":"","FieldGroupBRef":""}},"OutputRecordTypes":null,"MaxConnectionsTracked":0,"OutputFields":null,"Scheduling":null, "TCPFlags":{"CorrectDirection":false, "DetectEndConnection":false, "FieldName":""}}}}`, string(b))
