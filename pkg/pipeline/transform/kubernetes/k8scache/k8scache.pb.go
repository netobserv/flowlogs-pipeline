...
type ResourceEntry struct {
	...
	Terminated        bool   `protobuf:"varint,17,opt,name=terminated,proto3" json:"terminated,omitempty"`                                        // For Pods: based on Succeeded/Failed status (jobs, ...)
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *ResourceEntry) GetTerminated() bool {
	if x != nil {
		return x.Terminated
	}
	return false
...
const file_k8scache_proto_rawDesc = "" +
	...
	"\toperation\x18\x04 \x01(\x0e2\x17.k8scache.OperationTypeR\toperation\"\xe2\x06\n" +
	...
	"\x10resource_version\x18\x0f \x01(\tR\x0fresourceVersion\x12\x1e\n" +
	"\n" +
	"terminated\x18\x11 \x01(\bR\n" +
	"terminated\x1aD\n" +
