...
// K8sV1alpha1Client is used to interact with features provided by the k8s.ovn.org group.
type K8sV1alpha1Client struct {
	restClient rest.Interface
}

func (c *K8sV1alpha1Client) NetworkQoSes(namespace string) NetworkQoSInterface {
	return newNetworkQoSes(c, namespace)
}
...
func setConfigDefaults(config *rest.Config) error {
	gv := networkqosv1alpha1.SchemeGroupVersion
